...
public class AggregatorController {
    ...
    public Entry getDefinition(@PathVariable String word){
    ...
    public List<Entry> getAllPalindromes(){
        ...
        long nanoSeconds = sw.getLastTaskTimeNanos();
        String message = new StringBuilder().append("Retrieved entries for palindrome words, ")
                .append(" Entries received in ")
                .append(nanoSeconds / 1000000.0)
                .append(" ms ")
                .toString();
